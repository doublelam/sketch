...
var Control_Semigroupoid = __webpack_require__(15);
var Data_Function = __webpack_require__(11);
...
var Control_Semigroupoid = __webpack_require__(15);
var Data_Boolean = __webpack_require__(38);
var Data_BooleanAlgebra = __webpack_require__(39);
var Data_Bounded = __webpack_require__(19);
var Data_CommutativeRing = __webpack_require__(34);
var Data_DivisionRing = __webpack_require__(48);
var Data_Eq = __webpack_require__(6);
var Data_EuclideanRing = __webpack_require__(32);
var Data_Field = __webpack_require__(49);
var Data_Function = __webpack_require__(11);
var Data_Functor = __webpack_require__(0);
var Data_HeytingAlgebra = __webpack_require__(18);
var Data_NaturalTransformation = __webpack_require__(95);
...
var Data_Semiring = __webpack_require__(10);
var Data_Show = __webpack_require__(8);
var Data_Unit = __webpack_require__(5);
var Data_Void = __webpack_require__(35);
module.exports = {};
...
var Data_Eq = __webpack_require__(6);
var Data_Function = __webpack_require__(11);
var Data_Ord_Unsafe = __webpack_require__(90);
var Data_Ordering = __webpack_require__(20);
var Data_Ring = __webpack_require__(24);
var Data_Semiring = __webpack_require__(10);
var Data_Unit = __webpack_require__(5);
...
var Control_Alt = __webpack_require__(25);
var Control_Alternative = __webpack_require__(36);
var Control_Applicative = __webpack_require__(2);
var Control_Apply = __webpack_require__(3);
var Control_Bind = __webpack_require__(9);
var Control_Category = __webpack_require__(13);
...
var Control_Monad = __webpack_require__(14);
var Control_MonadZero = __webpack_require__(97);
var Control_Plus = __webpack_require__(33);
var Data_Bounded = __webpack_require__(19);
var Data_Eq = __webpack_require__(6);
var Data_Function = __webpack_require__(11);
var Data_Functor = __webpack_require__(0);
var Data_Functor_Invariant = __webpack_require__(22);
var Data_Monoid = __webpack_require__(16);
var Data_Ord = __webpack_require__(7);
var Data_Ordering = __webpack_require__(20);
var Data_Semigroup = __webpack_require__(4);
var Data_Show = __webpack_require__(8);
...
var Data_Functor = __webpack_require__(0);
var Data_HeytingAlgebra = __webpack_require__(18);
var Data_Maybe = __webpack_require__(21);
var Data_Maybe_First = __webpack_require__(42);
var Data_Maybe_Last = __webpack_require__(54);
var Data_Monoid = __webpack_require__(16);
var Data_Monoid_Additive = __webpack_require__(55);
...
var Data_Monoid_Endo = __webpack_require__(56);
var Data_Monoid_Multiplicative = __webpack_require__(57);
...
var Data_Monoid_Dual = __webpack_require__(45);
var Data_Monoid_Multiplicative = __webpack_require__(57);
var Data_Traversable_Accum = __webpack_require__(59);
var Data_Traversable_Accum_Internal = __webpack_require__(99);
var Prelude = __webpack_require__(1);
...
var Control_Biapply = __webpack_require__(27);
...
var Control_Monad_Eff = __webpack_require__(30);
...
var Control_Category = __webpack_require__(13);
var Control_Semigroupoid = __webpack_require__(15);
var Data_Bifunctor_Clown = __webpack_require__(47);
...
var Control_Apply = __webpack_require__(3);
var Control_Bind = __webpack_require__(9);
var Control_Comonad = __webpack_require__(28);
var Control_Extend = __webpack_require__(17);
var Control_Monad = __webpack_require__(14);
var Data_Bounded = __webpack_require__(19);
var Data_Eq = __webpack_require__(6);
...
var Partial = __webpack_require__(101);
...
var Control_Apply = __webpack_require__(3);
var Control_Category = __webpack_require__(13);
var Data_Bifoldable = __webpack_require__(41);
var Data_Bifunctor = __webpack_require__(23);
var Data_Bifunctor_Clown = __webpack_require__(47);
var Data_Bifunctor_Flip = __webpack_require__(50);
var Data_Bifunctor_Joker = __webpack_require__(51);
...
var Data_Bifunctor_Wrap = __webpack_require__(53);
var Data_Functor = __webpack_require__(0);
var Data_Traversable = __webpack_require__(29);
var Prelude = __webpack_require__(1);
...
var Control_Bind = __webpack_require__(9);
var Control_Monad_Eff = __webpack_require__(30);
var Control_Monad_ST = __webpack_require__(37);
var Control_Semigroupoid = __webpack_require__(15);
var Data_Maybe = __webpack_require__(21);
var Prelude = __webpack_require__(1);
var Unsafe_Coerce = __webpack_require__(104);
...
var Data_Bounded = __webpack_require__(19);
var Data_CommutativeRing = __webpack_require__(34);
var Data_Distributive = __webpack_require__(108);
var Data_Eq = __webpack_require__(6);
var Data_Foldable = __webpack_require__(26);
var Data_Function = __webpack_require__(11);
var Data_Functor = __webpack_require__(0);
...
var Data_Unit = __webpack_require__(5);
var Prelude = __webpack_require__(1);
var Type_Equality = __webpack_require__(109);
var Tuple = (function () {
...
var reorderArr = __webpack_require__(70);
console.log('reorder', reorderArr);
...
var Data_Array = __webpack_require__(71);
var Data_Boolean = __webpack_require__(38);
var Data_EuclideanRing = __webpack_require__(32);
var Data_Foldable = __webpack_require__(26);
var Data_Ord = __webpack_require__(7);
var Data_Semiring = __webpack_require__(10);
var MabeConvert = __webpack_require__(112);
var Prelude = __webpack_require__(1);
var reorderImgArr = (function () {
    var _rIA = function ($copy_pixels) {
        return function ($copy_xs) {
            var $tco_var_pixels = $copy_pixels;
            var $tco_done = false;
            var $tco_result;
            function $tco_loop(pixels, xs) {
                if (Data_Array.length(xs) <= 4) {
                    $tco_done = true;
                    return pixels;
                };
                if (Data_Boolean.otherwise) {
                    var rawRGB = Data_Array.take(3)(xs);
                    var headArr = {
                        rawRGB: rawRGB, 
                        opacity: MabeConvert.maybeInt(Data_Array.last(xs)), 
                        grayscale: Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt)(rawRGB) / 3 | 0
                    };
                    $tco_var_pixels = Data_Array.cons(headArr)(pixels);
                    $copy_xs = Data_Array.drop(4)(xs);
                    return;
                };
                throw new Error("Failed pattern match at ProcessImg line 16, column 5 - line 16, column 52: " + [ pixels.constructor.name, xs.constructor.name ]);
            };
            while (!$tco_done) {
                $tco_result = $tco_loop($tco_var_pixels, $copy_xs);
            };
            return $tco_result;
        };
    };
...
var Control_Lazy = __webpack_require__(40);
var Control_Monad_Eff = __webpack_require__(30);
var Control_Monad_Rec_Class = __webpack_require__(80);
var Control_Monad_ST = __webpack_require__(37);
var Control_Semigroupoid = __webpack_require__(15);
var Data_Array_ST = __webpack_require__(61);
var Data_Array_ST_Iterator = __webpack_require__(106);
var Data_Boolean = __webpack_require__(38);
var Data_Eq = __webpack_require__(6);
var Data_Foldable = __webpack_require__(26);
var Data_Function = __webpack_require__(11);
...
var Data_HeytingAlgebra = __webpack_require__(18);
var Data_Maybe = __webpack_require__(21);
var Data_NonEmpty = __webpack_require__(107);
var Data_Ord = __webpack_require__(7);
var Data_Ordering = __webpack_require__(20);
var Data_Ring = __webpack_require__(24);
var Data_Semigroup = __webpack_require__(4);
var Data_Semiring = __webpack_require__(10);
var Data_Traversable = __webpack_require__(29);
var Data_Tuple = __webpack_require__(62);
var Data_Unfoldable = __webpack_require__(110);
...
var Control_Monad = __webpack_require__(14);
var Control_Monad_Eff = __webpack_require__(30);
var Control_Monad_Eff_Unsafe = __webpack_require__(81);
var Control_Monad_ST = __webpack_require__(37);
var Control_Semigroupoid = __webpack_require__(15);
var Data_Bifunctor = __webpack_require__(23);
var Data_Either = __webpack_require__(84);
var Data_Functor = __webpack_require__(0);
var Data_Identity = __webpack_require__(60);
var Data_Maybe = __webpack_require__(21);
var Data_Unit = __webpack_require__(5);
var Partial_Unsafe = __webpack_require__(46);
var Prelude = __webpack_require__(1);
...
var maybeInt = function (v) {
    ...
    throw new Error("Failed pattern match at MabeConvert line 10, column 1 - line 10, column 29: " + [ v.constructor.name ]);
};

// import Data.Array
var maybeArr = function (v) {
    if (v instanceof Data_Maybe.Just) {
        return v.value0;
    };
    if (v instanceof Data_Maybe.Nothing) {
    ...
    throw new Error("Failed pattern match at MabeConvert line 6, column 1 - line 6, column 49: " + [ v.constructor.name ]);
};
module.exports = {
    maybeArr: maybeArr, 
    maybeInt: maybeInt
